...
export const ABOUT_CARDS: ICardsQuestion[] = [
	{
		text: 'Есть коммерческий опыт разработки в ярославской компании <<АВИТЕК>>. c 06.2022 до 05.2023. Разработал в команде систему по автоматизации отчетов, комуникации между сотрудниками, админ панель',
		icon: BsCashCoin
	},
	{
