...
export const ABOUT_CARDS: ICardsQuestion[] = [
	{
		text: 'Есть коммерческий опыт разработки в ярославской компании <<АВИТЕК>>. c 10.08.2022 до 05.04.2023. Разработал в команде систему по автоматизации отчетов, комуникации между сотрудниками, админ панель',
		icon: BsCashCoin
	},
	{
